...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-logout-logout-module"], {
  ...
  /***/
  function srcAppPagesLogoutHelloComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppPagesLogoutLogoutModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _hello_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    /*! ./hello.component */
    "./src/app/pages/logout/hello.component.ts");
    ...
    LogoutPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _logout_routing_module__WEBPACK_IMPORTED_MODULE_5__["LogoutPageRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]],
  ...
  function srcAppPagesLogoutLogoutPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _model_global_api__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ../../model/global-api */
    ...
    var src_app_services_assignments_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! src/app/services/assignments.service */
    "./src/app/services/assignments.service.ts");

    var LogoutPage = /*#__PURE__*/function () {
      function LogoutPage(router, platform, storage, assignmentsService, nativeHttp, globalService, alertController, formBuilder) {
        ...
        this.error_messages = {
          'password': [{
            ...
            type: 'minlength',
            message: 'Password length is required to be between 6 to 30.'
          }, {
            type: 'maxlength',
            message: 'Password length is required to be between 6 to 30.'
          }],
        ...
        this.loginForm1 = this.formBuilder.group({
          password: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].minLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].maxLength(30)])),
          confirmpassword: new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].minLength(6), _angular_forms__WEBPACK_IMPORTED_MODULE_8__["Validators"].maxLength(30)]))
        }, {
      ...
      _createClass(LogoutPage, [{
                      ...
                      return this.alertController.create({
                        ...
                        buttons: [{
                          ...
                          handler: function handler() {
                            ...
                            _this3.storage.remove('mysession');

                            _this3.storage.remove('assignmentdetails');

                            _this3.storage.remove('authlogin');

                            _this3.storage.remove('joinsession');

                            _this3.storage.remove('chatdetails');

                            _this3.storage.remove('User_Id');

                            _this3.storage.remove('Authentication_Token');
        ...
        key: "togglePassword4",
        value: function togglePassword4() {
        ...
        key: "togglePassword5",
        value: function togglePassword5() {
                    ...
                    return this.alertController.create({
                      ...
                      buttons: [{
                        ...
                        handler: function handler() {
                          ...
                          _this4.assignmentsService.presentpasswordsuccess();
                        }
                      }]
                    });
